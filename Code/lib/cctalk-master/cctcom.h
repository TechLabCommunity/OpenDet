...
const unsigned char maxDataLength = 58; // the maximum data field length
const unsigned long interbytetimeout = 100;// the timeout for next byte in the same message 
const unsigned long answertimeout = 200;// the answer timeout , it might be longer for some pools like eeprom writing
